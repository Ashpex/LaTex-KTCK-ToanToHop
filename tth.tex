...
- Khi đó, ta có \(N(A_{i}) = n^{3}\) vì hai đỉnh của cạnh \(e_{i}\) được tô cùng 1 màu và ta có thể tô màu bất kỳ cho 2 đỉnh còn lại
...
- Từ đó, ta dễ dàng suy ra số lượng đường đi từ \(O\) đến \(A\) chính là số Catalan thứ \(n\):
